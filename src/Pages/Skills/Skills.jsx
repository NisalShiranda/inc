  ...
  return (
    <>
        <div className="skills-container px-5 sm:px-32 py-16 grid grid-cols-1 justify-center items-center sm:grid sm:grid-cols-2 lg:grid lg:grid-cols-4">
            ...
            <div className="grid grid-cols-1 pt-5 sm:pt-0 justify-center items-center sm:grid sm:grid-cols-2">
            ...
            <div className="grid grid-cols-1 justify-center items-center pt-5 sm:pt-0 sm:grid sm:grid-cols-2">
